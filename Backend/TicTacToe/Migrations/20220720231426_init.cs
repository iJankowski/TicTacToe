        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Queue = table.Column<bool>(type: "INTEGER", nullable: false),
                    State = table.Column<int>(type: "INTEGER", nullable: false),
                    FirstPlayerId = table.Column<Guid>(type: "TEXT", nullable: true),
                    SecondPlayerId = table.Column<Guid>(type: "TEXT", nullable: true),
                    GamesWonByOwner = table.Column<int>(type: "INTEGER", nullable: false),
                    GamesWonByJoiner = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovesHistory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MovesHistory_Games_GameId",
                        column: x => x.GameId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfMove = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Moves_MovesHistory_HistoryId",
                        column: x => x.HistoryId,
                        principalTable: "MovesHistory",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Moves_HistoryId",
                table: "Moves",
                column: "HistoryId");

            migrationBuilder.CreateIndex(
                name: "IX_MovesHistory_GameId",
                table: "MovesHistory",
                column: "GameId");
        }
